<template>
    <NuxtLayout name="default">
        <div class="flex flex-col gap-4 pt-4">
            ...
            <p class="text-l font-semibold text-white">
            To join the Grand Line Webring, <a href="" class="px-1 bg-red-500">submit a pull request</a> to our GitHub repository. Be sure to include your site URL, your alias, and your 88x31 button (optional)!
            We'll review your submission as fast as we can, and remember to include the widget on your site for all to see. Read the <a href="" class="px-1 bg-red-500">README.md</a> to make sure you've covered all the criterias to join!
            </p>
            <h2 class="text-3xl font-bold text-white">Webring Widgets</h2>
            <p class="text-l font-semibold text-white">
            You could either use the white or black SVG below (click them to download), or <a href="" class="px-1 bg-red-500">download it from here</a> and change the color yourself!
            </p>
